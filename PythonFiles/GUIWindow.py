...
class GUIWindow():
    ...
    def create_test_frames(self, queue):
        ...
        self.test_frames = []
        test_list = list(self.gui_cfg.getTests().values())
    ...
    def run_all_tests(self):
        ...
        cur_name = list(self.gui_cfg.getTests().values())[self.current_test_index]['name']
    ...
    def go_to_next_test(self):
        ...
        if not self.run_all_tests_bool:        
            ...
            if (self.running_all_idx < total_num_tests):
                ...
                cur_name = list(gui_cfg.getTests().values())[self.current_test_index]['name']
                logger.debug('Current test is: %s' % cur_name)
