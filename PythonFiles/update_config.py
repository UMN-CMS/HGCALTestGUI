...
LD_4MOD_NAMES = ["WE40A1", "WE40A2", "WE31A1", "WE31A3"]
...
def update_config(full_id):
    if full_id[3:9] in LD_4MOD_NAMES:
        cfg_type = "LD_4Mod_Wagon"
    elif full_id[3:5] == "WW" or full_id[3:5] == "WE":
        cfg_type = "LD_Wagon"
    elif full_id[3:5] == "WH":
        cfg_type = "HD_Wagon"
    elif full_id[3:9] == "ZPLMEZ" or full_id[3:9] == "ZPLMZ2":
        cfg_type = "Mezz"
    elif full_id[3:5] == "ZP":
        cfg_type = "Zipper"
    elif full_id[3:5] == "EL":
