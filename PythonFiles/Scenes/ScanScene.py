...
class ScanScene(tk.Frame):
    ...
    def initialize_GUI(self, parent, master_frame):
        ...
        lbl_snum = tk.Label(
            Scan_Board_Prompt_Frame, text="Serial Number:", font=("Arial", 16)
        )
        ...
        user_text.trace(
            "w", lambda name, index, mode, sv=user_text: self.show_submit_button()
        )
